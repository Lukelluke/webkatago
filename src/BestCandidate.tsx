...
interface BestCanditateState {
    candidate?: string;
}

class BestCandidate extends React.Component<BestCanditateProps, BestCanditateState>  {
    constructor(props: BestCanditateProps) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        ...
        info = this.props.candidates[this.props.order];
        if (info != null) {
...
class GoIntersection extends React.PureComponent<GoIntersectionProps, GoIntersectionState> {
    render() {
        ...
        return (
            <div className="go-intersection" style={intersectionStyle}>
